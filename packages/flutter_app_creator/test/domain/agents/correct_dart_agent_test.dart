import 'dart:convert';
import 'dart:io';
import 'package:flutter_app_creator/domain/agents/correct_dart_agent.dart';
...
error - The method 'MaterialAppX' isn't defined for the type 'MyApp' - lib\main.dart:13:12 - undefined_method
      ...
      final errorEntity = BuildResultEntity(true, errorMessage: errorMessage);

      final agent = CorrectDartAgent(
        tempDir,
        GenerativeModel(
      ...
      final response = await agent.process(jsonEncode(errorEntity));
